...
#  jpeg("C:/Users/user/Documents/Dissertation/transfer models final/NB/Data-Examples/Data1-NB/DS1_acf_unknown.jpeg", height=350,width = 500, units = 'mm', res = 300)
  ...
  names		 = c(list(bquote(alpha[0])),list(bquote(alpha[1])),list(bquote(beta[1])), "r",list(bquote(omega[0])))
  if (isi==1) 
  {
...
ts.plot(x, z, gpars = list(col = c("black", "red")))
...
#jpeg("C:/Users/user/Documents/Dissertation/transfer models final/NB/Data-Examples/Data1-NB/DS1_pred_unknown.jpeg", height=200,width = 350, units = 'mm', res = 300)
